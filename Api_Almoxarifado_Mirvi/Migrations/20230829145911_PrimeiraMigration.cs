    ...
    public partial class PrimeiraMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeTotalInstalada = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FotoPDF = table.Column<byte[]>(type: "longblob", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartBuyItemId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartBuyItems", x => x.CartBuyItemId);
                    table.ForeignKey(
                        name: "FK_CartBuyItems_Produto_ProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartBuyItems_ProdutoId",
                table: "CartBuyItems",
                column: "ProdutoId");
